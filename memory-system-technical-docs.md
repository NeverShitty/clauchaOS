...
### File Structure
```
/Users/noshit/MCMANSION/AUTOMATION_LAB/
...
# Add to crontab
# Hourly pruning
0 * * * * cd /Users/noshit/MCMANSION/AUTOMATION_LAB && python enhanced_vector_memory.py prune

# Daily backup
0 2 * * * /Users/noshit/MCMANSION/AUTOMATION_LAB/daily_memory_backup.sh

# Weekly stats report
0 9 * * 1 cd /Users/noshit/MCMANSION/AUTOMATION_LAB && python memory_manager.py > weekly_report.txt
```
...
memory_id = memory.add_memory_with_decay(
    content="TRO motion filed with Cook County court",
    context="Legal proceedings for ARIBIA LLC",
...
m.add_memory_with_decay(
    ...
    'Cook County Case 2024-CH-00123',
    decay_type='legal'
)
"
```
...
memory.add_memory_with_decay(
    ...
    context="ARIBIA LLC financial audit",
...
| CLAUDE_MEMORY_PATH | Base directory | /Users/noshit/MCMANSION/AUTOMATION_LAB |
...
### C. Recovery Scripts
Available in `/Users/noshit/MCMANSION/AUTOMATION_LAB/recovery/`:
