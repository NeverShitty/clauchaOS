...
ASSISTANT_CONFIG = {
    "METACLAUDE": {"id": "your-assistant-id-here", "tag": "META", "color": "🔵"},
    "CLAUDALYN": {"id": "your-assistant-id-here", "tag": "LYN", "color": "🟣"},
    "CLAUDEFO": {"id": "your-assistant-id-here", "tag": "FO", "color": "💰"},
    "CLAUDESQ": {"id": "your-assistant-id-here", "tag": "SQ", "color": "⚖️"},
    "CLAUDEMOM": {"id": "your-assistant-id-here", "tag": "MOM", "color": "💗"},
    "CLAUDEMO": {"id": "your-assistant-id-here", "tag": "MO", "color": "🎭"},
    "CLAUDESQUAD": {"id": "your-assistant-id-here", "tag": "SQUAD", "color": "💼"},
    "CLAUDEXTER": {"id": "your-assistant-id-here", "tag": "XTER", "color": "🛒"},
    "CLAUDEBABY": {"id": "your-assistant-id-here", "tag": "BABY", "color": "🦈"},
    "CLAUDETTE": {"id": "your-assistant-id-here", "tag": "ETTE", "color": "⚡"},
    "CLAUDADDY": {"id": "your-assistant-id-here", "tag": "DADDY", "color": "🐻"}
}
...
📎 Doc: /path/to/your/directory.pdf
📎 Doc: /path/to/your/directory.md
...
💾 Fix: https://gist.github.com/your-username/fix-script
...
📁 Config: ~/.tmux.conf
💾 Backup: https://gist.github.com/your-username/tmux-config
...
📂 Working Dir: /path/to/your/directory
...
- `"path:/path/to/your/directory"` - By file path
...
💾 Fix PR: https://github.com/YourCompany/app/pull/123
...
📎 Motion: /path/to/your/directory.pdf
📎 Exhibits: /path/to/your/directory.zip
...
📊 Report: /path/to/your/directory.xlsx
...
- Initiative documents → Store in /YOUR_PROJECT_DIR/SYSTEM_DOCS/
- Performance metrics → Include monitoring links
Example: [#META_...] System architecture updated
📎 Diagram: /YOUR_PROJECT_DIR/SYSTEM_DOCS/architecture_v3.svg
...
🔗 CI/CD: https://app.circleci.com/pipelines/YourCompany
...
"""
    ...
    # Save the script
    script_path = f"/path/to/your/directory{instance_name.lower()}_memory.py"
...
"""
    ...
    guide_file = "/path/to/your/directory.md"
