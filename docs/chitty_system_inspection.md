...
## Primary Directive
Execute comprehensive system analysis of the Chitty Stacks monorepo focusing on storage architecture, evidence chain integrity, and Your County legal compliance optimization.
...
- Review data retention policies for Your County compliance (7-year retention)
...
**Role**: Your County standards validator
**Tasks**:
...
- Your County evidence standards adherence
...
2. **Compliance Audit**: Your County standards verification
